  ...
  <div>
    ...
    >
      ...
      <el-form-item label="申 请 描 述" prop="description" label-width="90px">
        <el-input
          type="textarea"
          v-model.trim="applicationForm.description"
          @keyup.enter.native="submitForm('applicationForm')"
          placeholder="申请描述"
        ></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        institute: [{ required: true, message: '请输入所在机构', trigger: 'blur' }],
      },
    };
  },
  mounted() {
